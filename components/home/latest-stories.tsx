          ...
          <div className="flex flex-col gap-3">
            {sidebarArticles.map((article) => (
              <Link
                ...
                className="group flex gap-3 rounded-lg border border-border bg-neutral-50/60 p-3.5 transition-colors hover:border-neutral-300 hover:bg-neutral-100 dark:bg-neutral-900/50 dark:hover:border-neutral-700 dark:hover:bg-neutral-900"
              >
                {article.imageUrl && (
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h3 className="line-clamp-2 text-sm font-medium leading-snug text-neutral-900 dark:text-white">
                    {article.title}
                  </h3>
                  <time
