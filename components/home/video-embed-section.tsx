...
export function VideoEmbedSection() {
  return (
    <section className="py-12">
      <h2 className="text-xl font-semibold text-white">Weekly Recap</h2>
      <p className="mt-1 text-sm text-neutral-400">
        Here&apos;s what mattered this week — video breakdown.
      </p>
      <div className="mt-6 overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900/50">
        {YOUTUBE_VIDEO_ID ? (
          ...
          <a
            ...
            className="flex aspect-video flex-col items-center justify-center gap-3 transition-colors hover:bg-neutral-800/50"
          >
            <svg
              viewBox="0 0 28 20"
